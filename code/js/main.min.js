...
$(document).ready(function() {
	...
	$("#btn-reset-page-3").click(function(e){
		...
		page3Amount = 15;
		$(".page3Amount").text(" - 15 Stages");
		populateIcons("-page3", 15);
		addListeners();
	});
	...
	function dragStage(data){
		if(!startDrag){
			if(data.fromGrid._element.classList[1] != data.toGrid._element.classList[1]){
